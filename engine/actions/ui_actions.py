...
from engine.models.runtime import ActionResult, ExecutionContext, ErrorType
from hardware_adapters.mytRpc import MytRpc
from . import _rpc_bootstrap

# Import everything from specialized modules
from . import ui_touch_actions
from . import ui_input_actions
from . import ui_selector_actions
from . import ui_app_actions
from . import ui_device_actions
...
from .ui_touch_actions import (
    ...
    _resolve_coords, _to_int, _close_rpc, _discover_physical_resolution
)
from .ui_input_actions import INPUT_TEXT_METADATA, KEY_PRESS_METADATA
from .ui_app_actions import APP_OPEN_METADATA, APP_STOP_METADATA, APP_ENSURE_RUNNING_METADATA
from .ui_device_actions import CAPTURE_COMPRESSED_METADATA
...
@_with_sync
def selector_clear(params: Dict[str, Any], context: ExecutionContext, *, close_rpc: Any = None) -> ActionResult:
...
_is_rpc_enabled = lambda: _rpc_bootstrap.os.environ.get("MYT_ENABLE_RPC", "1") == "1"
...
def _sync_late_patches():
    ...
    for mod in [ui_touch_actions, ui_input_actions, ui_selector_actions, ui_app_actions, ui_device_actions]:
        if hasattr(mod, "MytRpc") and getattr(mod, "MytRpc") != current_rpc:
            setattr(mod, "MytRpc", current_rpc)
    ...
    for helper_name in ["_get_rpc", "_close_rpc"]:
        if hasattr(ua, helper_name):
            ...
            for mod in [ui_touch_actions, ui_input_actions, ui_selector_actions, ui_app_actions, ui_device_actions, _selector_support]:
