...
- **Distillation tools** (`core/golden_run_distillation.py` and related pipelines) must use generic XML feature extraction; state label inference must not match app-specific keywords.
