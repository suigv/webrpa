...
- 已落地文档对 `sdk_actions` 的口径仍是“继续观察，但不是当前阻塞项”，参考 `docs/current_main_status.md:18`、`功能原子化修复结果.md:124`
...
- 现有 watchpoint 文档：`docs/current_main_status.md:18`、`docs/reference/atomicity_architecture_review.md:49`、`功能原子化问题分类说明.md:79`、`功能原子化修复结果.md:124`
...
- 成果文档明确把这组变化定义为“facade 拆分已完成”，见 `功能原子化修复结果.md:44`
...
- `ui_actions` 当时已经有 selector/node 子系统和 RPC 生命周期问题，拆分直接对应资源释放与契约稳定收益，见 `功能原子化修复结果.md:13`、`功能原子化修复结果.md:28`
...
- 现有文档已经把 `sdk_actions` 定位成 watchpoint，而不是 remediation blocker，见 `docs/current_main_status.md:18`、`功能原子化修复结果.md:124`
