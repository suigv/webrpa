...
## Purpose
This document defines the north-star goals, scope boundaries, and success criteria for `webrpa`. It is the decision anchor for what we build (and what we explicitly do not build). Progress tracking belongs in `docs/governance/project_progress.md`, and execution planning belongs in `docs/strategy/ROADMAP.md`.
...
## Roadmap Link
See `docs/strategy/ROADMAP.md` for the milestone route and current completion status.
